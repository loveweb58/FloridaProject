        ...
        <Colxx xxs="12">
          <div className="mb-2">
            ...
            <div className="text-zero top-right-button-container">
              <Button color="primary" size="lg" className="top-right-button" onClick={() => toggleModal()}>
                    ...
                    label={
                      <span
                        className={`custom-control-label ${
                          selectedItemsLength > 0 && selectedItemsLength < itemsLength ? 'indeterminate' : ''
                        }`}
                      />
                    }
                  />
          ...
          <div className="mb-2">
            <Button color="empty" className="pt-0 pl-0 d-inline-block d-md-none" onClick={this.toggleDisplayOptions}>
