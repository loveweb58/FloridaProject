      ...
      <UncontrolledDropdown className="dropdown-menu-right">
        ...
        <DropdownMenu className="position-absolute mt-3" right id="iconMenuDropdown">
          ...
          <NavLink to="/app/ui" className="icon-menu-item">
            <i className="iconsminds-pantone d-block" /> <IntlMessages id="menu.ui" />
          </NavLink>
          <NavLink to="/app/ui/charts" className="icon-menu-item">
            <i className="iconsminds-bar-chart-4 d-block" /> <IntlMessages id="menu.charts" />
          </NavLink>
          <NavLink to="/app/applications/chat" className="icon-menu-item">
            <i className="iconsminds-speach-bubble d-block" /> <IntlMessages id="menu.chat" />
          </NavLink>
          <NavLink to="/app/applications/survey" className="icon-menu-item">
            <i className="iconsminds-formula d-block" /> <IntlMessages id="menu.survey" />
          </NavLink>
          <NavLink to="/app/applications/todo" className="icon-menu-item">
            <i className="iconsminds-check d-block" /> <IntlMessages id="menu.todo" />
          </NavLink>
        </DropdownMenu>
